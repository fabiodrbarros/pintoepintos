...
const dictionaries = {
  pt: {
    ...
    hero1: 'Mais do que madeira,', hero2: 'realizamos ideias.', heroIntro: 'Projetamos, fabricamos e instalamos soluções à medida, com a qualidade e o rigor de quem trabalha a madeira há gerações.',
    ...
    aboutUs: 'Sobre nós', aboutIntro: 'A Carpintaria Pinto & Pintos é uma empresa familiar, reconhecida pela qualidade, pelo profissionalismo e pela capacidade de corresponder ou superar as necessidades dos clientes e do mercado.', ourHistory: 'A nossa história',
    ...
    defines: 'O que nos define', detail1: 'Qualidade', detail2: 'em cada detalhe.', qualityP: 'Selecionamos cuidadosamente os materiais, trabalhamos com rigor em todas as etapas e acompanhamos cada projeto desde o desenho técnico à instalação, garantindo soluções duradouras e um acabamento irrepreensível.', stages: ['Conceção', 'Fabrico', 'Instalação'],
  ...
  en: {
    ...
    hero1: 'More than wood,', hero2: 'we bring ideas to life.', heroIntro: 'We design, manufacture and install bespoke solutions with the quality and precision of generations working with wood.',
    ...
    aboutUs: 'About us', aboutIntro: 'Carpintaria Pinto & Pintos is a family business recognised for quality, professionalism and the ability to meet or exceed the needs of clients and the market.', ourHistory: 'Our history', historyP1: 'Our origins date back to 1975, when Carpintaria Pinto began trading. In 1995, as the business passed from father to sons, it became Carpintaria Pinto & Pintos.', historyP2: 'Since then, we have grown with the same purpose: combining traditional craftsmanship with technology to create bespoke wood solutions for every client.', defines: 'What defines us', detail1: 'Quality', detail2: 'in every detail.', qualityP: 'We carefully select materials, work rigorously at every stage and follow each project from technical drawing to installation, ensuring durable solutions and impeccable finishes.', stages: ['Design', 'Manufacture', 'Installation'],
  ...
  fr: {
    ...
    hero1: 'Bien plus que du bois,', hero2: 'nous réalisons des idées.', heroIntro: 'Nous concevons, fabriquons et installons des solutions sur mesure, avec la qualité et la rigueur de générations dédiées au bois.',
    ...
    aboutUs: 'À propos', aboutIntro: 'Carpintaria Pinto & Pintos est une entreprise familiale reconnue pour sa qualité, son professionnalisme et sa capacité à répondre, voire à dépasser, les attentes de ses clients et du marché.', ourHistory: 'Notre histoire', historyP1: 'Nos origines remontent à 1975, avec la création de Carpintaria Pinto. En 1995, la transmission de l’activité du père aux fils donne naissance à Carpintaria Pinto & Pintos.', historyP2: 'Depuis, nous grandissons avec la même ambition : associer le savoir-faire traditionnel à la technologie pour créer des solutions en bois sur mesure.', defines: 'Ce qui nous définit', detail1: 'La qualité', detail2: 'dans chaque détail.', qualityP: 'Nous sélectionnons soigneusement les matériaux, travaillons avec rigueur à chaque étape et suivons chaque projet du dessin technique à la pose, pour garantir des solutions durables et des finitions impeccables.', stages: ['Conception', 'Fabrication', 'Installation'],
...
export function LanguageSelect({ className }: { className?: string }) {
  ...
  return (
    <select className={className} aria-label="Language / Langue / Idioma" value={locale} onChange={(event) => setLocale(event.target.value as Locale)}>
